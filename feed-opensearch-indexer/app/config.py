...
WORKER_MAX_RETRIES = int(os.getenv("WORKER_MAX_RETRIES", "10"))
JOB_CLEANUP_BATCH_SIZE = int(os.getenv("JOB_CLEANUP_BATCH_SIZE", "10000"))
...
REAPER_STALE_SECONDS = int(os.getenv("REAPER_STALE_SECONDS", "120"))
REAPER_RELEASE_DELAY_SECONDS = int(os.getenv("REAPER_RELEASE_DELAY_SECONDS", "30"))
