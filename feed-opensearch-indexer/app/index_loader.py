...
def parse_args():
    ...
    parser.add_argument("--mysql-sudo", action="store_true", default=env_bool("SOURCE_MYSQL_SUDO", False))
    ...
    parser.add_argument("--page-size", type=int, default=int(os.getenv("OPENSEARCH_LOADER_PAGE_SIZE", "500")))
